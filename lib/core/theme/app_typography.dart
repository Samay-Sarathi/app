...
class AppTypography {
  ...
  // Display
  static TextStyle displayXL = _inter(size: 64, weight: FontWeight.w900, height: 1.1);
  static TextStyle displayL = _inter(size: 48, weight: FontWeight.w800, height: 1.2);
  ...
  static TextStyle heading3 = _inter(size: 20, weight: FontWeight.w600, height: 1.4);

  // Body
  static TextStyle bodyL = _inter(size: 18, weight: FontWeight.w400, height: 1.6);
  static TextStyle body = _inter(size: 16, weight: FontWeight.w400, height: 1.5);
